...
# what I built
["My Summer Internships map" app](https://kimj0209.github.io/My_first_Map/) is an app that shows what summer internships I've done and other stops that are affiliated with the internships mentioned. This would show people the opprunities is people are interested on joining these internships.
<img src="img/eampleofmymapv1.gif" width="900" alt="GIF demo showing how a user can toggle through various maps and view the detailed itinerary" width="200"/>
_Showing what the map does._
